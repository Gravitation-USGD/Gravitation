[root@localhost gte-linux-amd64-1.9.2-e76047e9]# ./gte
NAME:
   gte - the go-ethereum command line interface

   Copyright 2013-2019 The go-ethereum Authors

USAGE:
   gte [options] command [command options] [arguments...]
   
VERSION:
   1.9.2-stable-e76047e9
...
COMMANDS:
   ...
   retesteth         Launches gte in retesteth mode
...
METRICS AND STATS OPTIONS:
  ...
  --metrics.influxdb.database value  InfluxDB database name to push reported metrics to (default: "gte")
